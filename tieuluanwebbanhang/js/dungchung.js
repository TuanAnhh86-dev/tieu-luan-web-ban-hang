...
function themVaoGioHang(masp, tensp) {
    ...
    animateCartNumber();
    addAlertBox('Đã thêm '  + ' vào giỏ.', '#17c671', '#fff', 3500);
	...
	<div class="top-nav group">
        <section>
            <div class="social-top-nav">
                <li><a href="https://www.facebook.com/ShopeeVN"><i class="fa fa-facebook"></i></a></li>
                <li><a href="https://www.instagram.com/Shopee_VN/"><i class="fa fa-instagram"></i></a></li>
...
function addHeader() {
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.png" alt="Trang chủ shopbee" title="Trang chủ shopbee">
            </a>
        </div> <!-- End Logo -->
            ...
            <div class="tools-member">
                ...
                <div class="cart">
                    <a href="">
                        ...
                        <span class="cart-name" >Giỏ hàng
                            <span class="cart-number">
                                <button class="header-cart__footer">
                                    <a class="header-cart__footer-btn">Thanh toán</a>
                                </button>
                            </span>
                        </span>
                    </a>
